...
async function stopStream()  { await window.api.invoke("obs:stopStreaming");  await refreshStatuses(); }
async function startRecord() { await window.api.invoke("obs:startRecording"); await refreshStatuses(); }
async function stopRecord()  { await window.api.invoke("obs:stopRecording");  await refreshStatuses(); }
